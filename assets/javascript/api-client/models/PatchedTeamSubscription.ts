 ...
 * 
 * @export
 * @interface PatchedTeamSubscription
 */
export interface PatchedTeamSubscription {
    /**
     * 
     * @type {string}
     * @memberof PatchedTeamSubscription
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the PatchedTeamSubscription interface.
 */
export function instanceOfPatchedTeamSubscription(value: object): boolean {
    let isInstance = true;
...
export function PatchedTeamSubscriptionFromJSON(json: any): PatchedTeamSubscription {
    return PatchedTeamSubscriptionFromJSONTyped(json, false);
}

export function PatchedTeamSubscriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedTeamSubscription {
...
export function PatchedTeamSubscriptionToJSON(value?: PatchedTeamSubscription | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
