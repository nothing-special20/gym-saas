"""
Django settings for Gym SaaS project.
...
SECRET_KEY = 'dSHBMCJDGJzPhVFzRSLnSTANxhgguFDBEaVWoDDt'
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'gym_saas_language'
...
WAGTAIL_SITE_NAME = 'Gym SaaS Content'

# Pegasus config

# replace any values below with specifics for your project
PROJECT_METADATA = {
    'NAME': gettext_lazy('Gym SaaS'),
    'URL': 'http://localhost:8000',
    'DESCRIPTION': gettext_lazy("Gym SaaS"),
    'IMAGE': 'https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg',
    'KEYWORDS': 'SaaS, django',
    'CONTACT_EMAIL': 'help@billmoretech.com',
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [('BMT', 'help@billmoretech.com')]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'gym_saas': {
            'handlers': ['console'],
            'level': os.environ.get('GYM_SAAS_LOG_LEVEL', 'INFO'),
        }
    }
}
